    ...
    <div class="main">
        ...
        <div class="andre-oppskrifter">
            ...
            <div class="oppskrift-liste">
                <h3>Gjærbakst:</h3>
                <ul class="oppskrift-liste-list">
                {#each yeast_bakeryList as yeast_bakery}
                    <YeastBakery yeast_bakery={yeast_bakery}></YeastBakery>
                {/each}
                </ul>
            </div>
            <div class="oppskrift-liste">
